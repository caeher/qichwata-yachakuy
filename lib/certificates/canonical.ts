...
/**
 * Version 1 canonical bytes are UTF-8 JSON with this exact key order, no
 * insignificant whitespace, NFC strings, and UTC dates in millisecond ISO form.
 */
...
export function hashCertificatePayload(canonicalJson: string): string {
