...
| `territorio-y-tiempo` / `lugares`, `tiempo`, `practica-03` | Explicar una ruta desde un punto de referencia y ordenar una anécdota según momento actual/día anterior | Conceptos `arriba/abajo`, relación de procedencia/dirección/cercanía, `actualmente`, `ayer`; `Pacha` y `Kunan p'unchay` como candidatos que requieren niveles distintos de cotejo | Sin unidad territorial en Pacheco. Calvo vol. 1 aporta acepciones localizadas para arriba/abajo/actualmente/ayer. Cahuana, *Manual de gramática quechua Cusco-Collao*, PDF 30 / impresa 29, documenta `kunan p’unchay` como “hoy día” y agrupa referencias espaciales y temporales. `kunan` aislado en Pacheco PDF 41 no basta por sí solo. | Respaldo léxico para conceptos y respaldo contextual complementario para la frase. `Pacha` sigue sin entrada/página verificadas; la frase Cahuana espera cotejo con Cusco, revisión humana y revisión de permisos. No concatenar entradas ni universalizar la lista del manual. |
